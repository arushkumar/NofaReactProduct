...
class ViewData extends Component {
    ...
    //    console.log("show me", sss)
            ...
            this.AllDataCtrl = () => {
                nofaServices.getFilesOnly(sss).then(
                    response => {
                        ...
                        console.log(ad)
                        console.log("hellow",this.state.value)
        ...
        this.myFunction=()=> {
            this.props.history.push("/program/admin");
          }
    }
    ...
    render() {
        ...
        return (
            ...
            <div className='prviewcss'>
                ...
                <PanelBar>
                    <PanelBarItem expanded={true} title={"Project Information"}>
                        <Col lg="12">
                            ...
                            <p><strong>Zip: </strong> {this.state.scrData.proj_zip}</p>
                        </Col>
                    </PanelBarItem>
                </PanelBar>
                <PanelBar>
                    <PanelBarItem expanded={true} title={"Project Overview"}>
                        <FormGroup row>
                            <Col xs="12" lg="4">
                ...
                <PanelBar>
                    <PanelBarItem expanded={true} title={"Supportive Service"}>
                        <FormGroup row>
                            <Col xs="12" lg="4">
                ...
                <PanelBar>
                    <PanelBarItem expanded={true} title={"Supportive Housing"}>
                        <FormGroup row>
                            <Col xs="12" lg="4">
                ...
                <PanelBar>
                    <PanelBarItem expanded={true} title={"Sponsor Certification"}>
                        <Col xs="12" lg="4">
                ...
                <PanelBar>
                    <PanelBarItem expanded={true} title={"Scoring"}>
                        <FormGroup row>
                            <Col xs="12" lg="4">
                ...
                <PanelBar>
                    <PanelBarItem expanded={true} title={"Excel Workbook"}>
                        <FormGroup row>
                            <Col xs="12" lg="4">
