...
export const email = value => !value ? "Email field is required." : emailRegex.test(value) ? "" : "Email is not in a valid format.";
...
export const phone = value => !value ? "Phone number is required." : phoneRegex.test(value) ? "" : "Not a valid phone number.";
